...
anomalib-demo % rsync -rlptzv --progress --exclude=.git --exclude=artifacts/ --exclude=wandb/ . "ubuntu@ec2-13-58-149-112.us-east-2.compute.amazonaws.com:/home/ubuntu/anomalib-demo"